...
PKGS_GUI="alacritty gimp fsearch rofi rofi-calc rofi-emoji geany mpv easyeffects"
PKGS_CLI="htop ncdu neovim btop ranger nvtop intel-gpu-tools sysbench"
PKGS_UTILS="git jq fzf fd ImageMagick spellcheck xcolor vsv xclip bat ripgrep yt-dlp gcc tree ffmpeg intel-undervolt vsftpd wget xorg-server-xephyr tesseract-ocr tesseract-ocr-ell tesseract-ocr-eng"
